...
This is the OPeNDAP CDF Data Handler. It is used
...
REQUIREMENTS
  ...
  o You also need a recent copy of CDF. We've
  tested this server with cdf version 3.1,
  although any recent version should work fine. If
  the configure script cannot find your copy of
  libnetcdf, use the --with-cdf options to tell it
